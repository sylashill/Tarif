...
const DetailView = (() => {
  ...
  function _tab(i){ _activeTab=i; document.getElementById('dv-content').innerHTML=_renderTab();
    document.querySelectorAll('.dv-tab-btn').forEach((b,idx)=>{
      // basit aktiflik güncelle
    });
    _render(); // tam re-render aktif sekme vurgusu için
  }
